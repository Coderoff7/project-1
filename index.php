	...
	<div class="card-columns listfeaturedtag">
			...
			<div class="row">
				...
				<div class="col-md-7">
					<div class="card-block">
						<h2 class="card-title"><a href="post.html"><?=$key['h1']?></a></h2>
						<h4 class="card-text"><?=$key['about']?></h4>
		...
		<div class="card">
			<div class="row">
				...
				<div class="col-md-7">
					<div class="card-block">
						<h2 class="card-title"><a href="post.html"><?=$key['h2']?></a></h2>
						<h4 class="card-text"><?=$key['about']?></h4>
						<div class="metafooter">
							<div class="wrapfooter">
								<span class="meta-footer-thumb">
		...
		<div class="card">
			<div class="row">
				...
				<div class="col-md-7">
					<div class="card-block">
						<h2 class="card-title"><a href="post.html"><?=$key['h3']?></a></h2>
						<h4 class="card-text"><?=$key['about']?></h4>
						<div class="metafooter">
							<div class="wrapfooter">
								<span class="meta-footer-thumb">
		...
		<div class="card">
			<div class="row">
				...
				<div class="col-md-7">
					<div class="card-block">
						<h2 class="card-title"><a href="post.html"><?=$key['h4']?></a></h2>
						<h4 class="card-text"><?=$key['about']?></h4>
						<div class="metafooter">
							<div class="wrapfooter">
								<span class="meta-footer-thumb">
	...
	<div class="card-columns listrecent">
		...
		<div class="card">
			...
			foreach ($stories as $key){
				?>
					<div class="card-block">
					<h2 class="card-title"><a href="post.html"><?=$key['h5']?></a></h2>
					<h4 class="card-text"><?=$key['about']?></h4>
					<div class="metafooter">
						<div class="wrapfooter">
							<span class="meta-footer-thumb">
